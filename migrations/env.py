...
def include_name(
    ...
    """
    Exclude LangGraph-managed checkpoint tables
    from Alembic autogeneration.

    These tables are created and migrated by
    PostgresSaver.setup(), not by our application's
